...
export const metadata: Metadata = {
	title: 'Tutu Mbuyisa - Full-Stack Developer',
	description:
	...
	authors: [{ name: '[Tutu Mbuyisa]' }],
	creator: '[Tutu Mbuyisa]',
	openGraph: {
		title: '[Tutu Mbuyisa] - Full-Stack Developer Portfolio',
		description:
		...
		url: 'https://tutumbuyisa.vercel.app/',
		siteName: '[Tutu Mbuyisa] - Portfolio',
		images: [
			{
				url: '/og-image.jpg',
				width: 1200,
				height: 630,
				alt: '[Tutu Mbuyisa] - Full-Stack Developer Portfolio',
			},
		],
		locale: 'en_US',
		type: 'website',
