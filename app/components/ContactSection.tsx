			...
			<div className="max-w-4xl mx-auto text-center">
				...
				>
					...
					<p className="text-gray-400 max-w-2xl mx-auto">
						Looking for a full-stack developer who can design, build, and ship scalable apps? I’d love to hear from you.
					</p>
					...
					<div className="flex justify-center gap-6">
						<a
							href="https://github.com/tutu-coder"
							target="_blank"
						...
						<a
							href="https://www.linkedin.com/in/tutu-mbuyisa-0898822ab/?trk=opento_sprofile_details"
							target="_blank"
							rel="noopener noreferrer"
							className="text-gray-400 hover:text-white transition-colors p-2 hover:bg-gray-800 rounded-lg"
						>
